...
| [OpenTSDB](http://opentsdb.net) | [abajwa](https://github.com/abajwa-hw/opentsdb-service) | Easy | deploy/manage OpenTSDB from Ambari | Use OpenTSDB to generate Google finance like UIs on sandbox | 
