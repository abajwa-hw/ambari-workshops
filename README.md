...
| [OpenTSDB](http://opentsdb.net) | [abajwa](https://github.com/abajwa-hw/opentsdb-service) | Easy | Deploy/monitor timeseries DB on top of HBase and implement your own Google Finance-like functionality |
